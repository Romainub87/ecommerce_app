...
test('obtenir les méthodes de livraison avec un poids nul (0kg)', function () {
...
test('obtenir les méthodes de livraison avec un poids positif (5kg)', function () {
    $service = new ApiService();
...
test('obtenir les méthodes de livraison avec un poids négatif (-1kg)', function () {
    $service = new ApiService();
...
test('obtenir les méthodes de livraison avec un poids très élevé (100kg)', function () {
    $service = new ApiService();
